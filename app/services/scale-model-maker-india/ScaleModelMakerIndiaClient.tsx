    ...
    galleryImages: [
      {
        ...
        description:
          "Full master plan view of the Shapoorji Pallonji luxury residential development with detailed landscaping and tower placement.",
      },
      {
        url: "/images/services/architectural-scale-models/shapoorji/02.jpeg",
        title: "Residential Tower Detail",
        description:
          "Close-up showing facade articulation, balcony design, and floor-level differentiation across the residential towers.",
      },
      {
        url: "/images/services/architectural-scale-models/shapoorji/03.jpeg",
        title: "Master Planning Layout",
        description:
          "Comprehensive model showing site organisation, road network, open spaces, and amenity zones.",
      },
      {
        url: "/images/services/architectural-scale-models/shapoorji/04.jpeg",
        title: "Premium Presentation View",
        description:
          "Sales office display perspective — crafted for investor presentations and high-ticket buyer walkthroughs.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        description:
          "Station building, platform arrangements, and passenger circulation at scale.",
      },
      {
        url: "/images/services/architectural-scale-models/railways/2.jpeg",
        title: "Platform Infrastructure",
        description:
          "Tracks, overhead structures, and signalling systems represented at precision scale.",
      },
      {
        url: "/images/services/architectural-scale-models/railways/3.jpeg",
        title: "Terminal Building Facade",
        description:
          "Main entrance, roof design, and structural elements of the station building.",
      },
      {
        url: "/images/services/architectural-scale-models/railways/4.jpeg",
        title: "Transit Integration Hub",
        description:
          "Connectivity between railway platforms and surrounding transportation networks.",
      },
      {
        url: "/images/services/architectural-scale-models/railways/5.jpeg",
        title: "Station Master Plan",
        description:
          "Bird's eye overview of complete railway infrastructure and track layout.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        title: "Township Clusters",
        description:
          "Residential tower arrangement showing neighbourhood layout and density distribution.",
      },
      {
        url: "/images/services/architectural-scale-models/hiranandani/2.jpeg",
        title: "Central Gardens",
        description:
          "Landscaped green spaces with walking paths, water features, and recreational zones.",
      },
      {
        url: "/images/services/architectural-scale-models/hiranandani/3.jpeg",
        title: "Tower Detail",
        description:
          "Individual tower model showcasing facade treatment and floor-to-floor heights.",
      },
      {
        url: "/images/services/architectural-scale-models/hiranandani/4.jpeg",
        title: "Community Centre",
        description:
          "Clubhouse, sports areas, and social gathering spaces at scale.",
      },
      {
        url: "/images/services/architectural-scale-models/hiranandani/5.jpeg",
        title: "Full Township Layout",
        description:
          "Complete site model with road networks, building clusters, and open space distribution.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        description:
          "Both towers with connecting podium and vertical circulation cores.",
      },
      {
        url: "/images/services/architectural-scale-models/venkatesh/2.jpeg",
        title: "Podium Amenities",
        description:
          "Ground floor lobbies, parking, and resident facility zones.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        description:
          "Integration of residential, retail, and commercial components at centre.",
      },
      {
        url: "/images/services/architectural-scale-models/spree/2.jpeg",
        title: "Residential Clusters",
        description:
          "Apartment buildings, row houses, and supporting infrastructure by phase.",
      },
      {
        url: "/images/services/architectural-scale-models/spree/3.jpeg",
        title: "Commercial Zone",
        description:
          "Business and retail district with office buildings and shopping complexes.",
      },
      {
        url: "/images/services/architectural-scale-models/spree/4.jpeg",
        title: "Green Corridor",
        description:
          "Interconnected parks, tree-lined avenues, and pedestrian pathways.",
      },
      {
        url: "/images/services/architectural-scale-models/spree/5.jpeg",
        title: "Complete Master Plan",
        description:
          "All development phases, infrastructure, and land use distribution in one model.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        description:
          "High-rise facade with detailed balcony projections and cladding.",
      },
      {
        url: "/images/services/architectural-scale-models/skyline/2.jpeg",
        title: "Rooftop Amenity Deck",
        description: "Pool, gym, and sky lounge at top-floor amenity level.",
      },
      {
        url: "/images/services/architectural-scale-models/skyline/3.jpeg",
        title: "Entrance Plaza",
        description:
          "Grand entrance, drop-off zone, and landscaped arrival court.",
      },
      {
        url: "/images/services/architectural-scale-models/skyline/4.jpeg",
        title: "Site Context",
        description:
          "Full development in relation to surrounding roads and urban fabric.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        title: "Tower Complex",
        description:
          "Office buildings, retail podium, and multi-level parking structures.",
      },
      {
        url: "/images/services/architectural-scale-models/island/2.jpeg",
        title: "Waterfront Promenade",
        description:
          "Pedestrian walkways, seating zones, and waterfront landscaping at scale.",
      },
    ],
  },
  {
    ...
    galleryImages: [
      {
        ...
        title: "Main Tower Complex",
        description:
          "Primary residential towers with surrounding landscape and pedestrian pathways.",
      },
      {
        url: "/images/services/architectural-scale-models/centonic/2.jpeg",
        title: "Amenity Zone",
        description: "Clubhouse, pool, and community spaces in miniature.",
      },
      {
        url: "/images/services/architectural-scale-models/centonic/3.jpeg",
        title: "Facade Detail",
        description: "Balcony arrangements and facade accuracy close-up.",
      },
      {
        url: "/images/services/architectural-scale-models/centonic/4.jpeg",
        title: "Master Plan Overview",
        description: "Full site planning and spatial organisation from above.",
      },
    ],
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl md:text-2xl text-white mb-4 leading-relaxed drop-shadow-lg">
                  Professional architectural model maker trusted by India&apos;s
                  top real estate developers, infrastructure companies, and
                  government agencies.
                </p>
                <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                  Precision miniature model making with CNC fabrication, LED
                  integration, hand-craft finishing, and white-glove pan-India
                  delivery — from Mumbai to Hyderabad.
                </p>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Size, number of towers, preferred scale, LED requirements..."
                    ></textarea>
                  </div>
                  <button
                    type="submit"
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        <span>Request My Scale Model Quote</span>
                  ...
                  {submitStatus === "success" && (
                    <p className="text-green-600 text-center font-semibold text-sm">
                      ✓ Thank you! We&apos;ll respond with a detailed quote
                      within 24 hours.
                    </p>
                  )}
                  {submitStatus === "error" && (
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                8 featured projects from our 200+ model portfolio — residential
                towers, township master plans, commercial developments, and
                infrastructure projects across Mumbai, Pune, Delhi NCR, and
                Hyderabad.
              </p>
            </div>
                    ...
                    <div className="relative h-96 md:h-[500px] overflow-hidden">
                      ...
                      {selectedItem.galleryImages.length > 1 && (
                        <>
                          <button
                            onClick={prevSlide}
                            className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/50 rounded-full flex items-center justify-center text-white hover:bg-black/70 cursor-pointer z-10"
                          >
                            <i className="ri-arrow-left-line text-xl"></i>
                          </button>
                          <button
                            onClick={nextSlide}
                            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/50 rounded-full flex items-center justify-center text-white hover:bg-black/70 cursor-pointer z-10"
                          >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                As a full-service scale model maker in India, we control every
                stage of production in-house — digital modelling to delivery. No
                outsourcing. No quality gaps.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                As a specialist scale model maker in India, we work across all
                project types — residential launches, township master plans,
                commercial hubs, and government infrastructure.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">
                Scale Ratios & Project Specifications
              </h2>
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Every scale model maker in India uses different ratios.
                Here&apos;s how we match the scale to your project type, display
                space, and required level of detail.
              </p>
            </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-800">
                  {[
                    ...
                    [
                      "1:100",
                      "Apartment block, boutique project",
                      "3–6 ft",
                      "High — floor detail",
                      "₹1.5L – ₹4L",
                    ],
                    [
                      "1:200",
                      "Mid-size residential complex",
                      "4–8 ft",
                      "Medium-High — facade detail",
                      "₹2.5L – ₹7L",
                    ],
                    [
                      "1:500",
                      "Large residential / commercial project",
                      "6–12 ft",
                      "Medium — massing + landscape",
                      "₹4L – ₹12L",
                    ],
                    [
                      "1:1000",
            ...
            <p className="text-gray-500 text-xs mt-4 text-center italic">
              Indicative 2026 pricing. GST additional. Final quote based on
              drawings, finish spec, LED scope, and delivery location.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Six structured stages from brief to installation — each with a
                formal client review checkpoint. No surprises. No rework. No
                missed launch dates.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  num: "01",
                  title: "Brief & Drawing Review",
                  desc: "We review your CAD/Revit drawings, confirm scale ratio, base dimensions, LED scope, and delivery date. Written production brief signed off before any fabrication.",
                },
                {
                  num: "02",
                  title: "Digital 3D Model Build",
                  desc: "Our team converts your drawings into a precise digital 3D model. You review and approve before any physical production begins — eliminating rework risk.",
                },
                {
                  num: "03",
                  title: "CNC & Laser Fabrication",
                  desc: "Building components, road surfaces, and structural elements are precision-cut using CNC routers and laser cutters driven directly from your digital files.",
                },
                {
                  num: "04",
                  title: "Assembly & LED Integration",
                  desc: "Components are assembled on the base board. LED systems are wired into concealed channels. Phase-wise lighting zones are tested for reliable sales office operation.",
                },
                {
                  num: "05",
                  title: "Painting, Landscaping & Finishing",
                  desc: "Facades are custom-painted to your specification. Landscaping layers — grass, trees, water bodies — are applied by hand for maximum realism. Protective acrylic cover fitted.",
                },
                {
                  num: "06",
                  title: "QC, Delivery & Installation",
                  desc: "Full quality inspection. Custom foam-crated for transport. Our team delivers, installs, tests all electrics, and briefs your sales staff on operation and maintenance.",
                },
              ].map((step) => (
                <div
                  key={step.num}
                ...
                >
                  <div className="text-6xl font-bold text-yellow-400/20 absolute top-6 right-6">
                    {step.num}
                  </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-black mb-4">
                Scale Model Maker Across India
              </h2>
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-gray-600 max-w-2xl mx-auto">
                We are your scale model maker in India — wherever your project
                is. Our team delivers and installs across all major cities.
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
              {[
                ...
                <div
                  key={city}
                  className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center hover:border-yellow-400 hover:bg-yellow-50 transition-colors"
                >
        ...
        <section className="py-24 bg-black">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Every material our architectural model maker team uses is
                selected for visual accuracy, structural durability, and
                long-term performance in a sales office environment.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "CNC-Cut Acrylic & ABS",
                  desc: "Precision-fabricated building shells, glazing panels, and structural components with razor-clean edges and tight tolerances.",
                },
                {
                  icon: "ri-water-flash-line",
                  title: "Clear Acrylic Glazing",
                  desc: "Transparent and frosted acrylic for building facades, water feature surfaces, and illuminated podium levels.",
                },
                {
                  icon: "ri-lightbulb-flash-line",
                  title: "SMD LED Systems",
                  desc: "Warm-white and cool-white SMD LEDs with fibre optics for star-field and water effects — wired for 24/7 reliability.",
                },
                {
                  icon: "ri-tree-line",
                  title: "Architectural Model Foliage",
                  desc: "Professional model grass mats, scatter foliage, and pre-made tree armatures — chosen by species, not generic green.",
                },
                {
                  icon: "ri-paint-fill",
                  title: "Custom-Mixed Paints",
                  desc: "Facade colours matched to your actual specification. Powder-coat durable finishes that don't chip or fade under sales office lighting.",
                },
                {
                  icon: "ri-map-pin-line",
                  title: "Laser-Etched Road Surfaces",
                  desc: "Roads, footpaths, parking bays, and paving patterns engraved directly onto base surfaces — crisp and consistent at any scale.",
                },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              {[
                {
                  q: "What makes Alliance Media Labs the best scale model maker in India?",
                  a: "We are one of India's few scale model makers who control the entire production chain in-house — CNC fabrication, LED integration, hand-finishing, and pan-India installation. With 200+ projects delivered for Shapoorji Pallonji, Hiranandani, Venkatesh Buildcon, and others, our track record speaks directly to our quality and reliability.",
                },
                {
                  q: "How much does a scale model cost in India?",
                  a: "Prices range from ₹75,000 for a simple villa model to ₹20,00,000+ for a large LED-lit township master plan. The main cost drivers are model size, scale ratio, LED scope, finish quality, and delivery location. We provide detailed itemised quotes within 48 hours of receiving your drawings.",
                },
                {
                  q: "How long does the model making process take?",
                  a: "Standard residential block models: 15–25 working days. Large township master plans: 30–50 working days. Rush production (7–15 days) is available at a premium. Timeline starts from drawing sign-off, not from order placement.",
                },
                {
                  q: "What files do you need to start?",
                  a: "AutoCAD DWG site plans, building floor plans, and elevation drawings are the minimum. Revit and SketchUp files are preferred. We can work from PDF drawings but it adds interpretation time. The more complete your digital files, the faster and more accurate the production.",
                },
                {
                  q: "Do you handle delivery and installation across India?",
                  a: "Yes. We custom-crate every model in foam-lined wooden cases, supervise transport, and send our team to site for installation, electrical testing, and sales staff briefing. We cover Mumbai, Delhi NCR, Bangalore, Pune, Hyderabad, Gurugram, Chennai, and all major Indian cities.",
                },
                {
                  q: "Can the model be updated if the building design changes?",
                  a: "Yes. We retain digital model files for all projects. Design changes — new towers, facade updates, landscaping revisions — can be incorporated as targeted updates without rebuilding the full model. Turnaround for component updates is typically 7–15 working days.",
                },
              ].map((faq, i) => (
                <div
                  key={i}
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      label: "Architectural Scale Models Service",
                    ...
                    <Link
                      key={s.href}
                      href={s.href}
                      className="flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-200 hover:border-yellow-400 transition-colors group"
                    >
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      label:
                        "Best Architectural Scale Model Company India: How to Choose",
                      href: "/blog/best-architectural-scale-model-company-india",
                    },
                    {
                      label:
                        "Scale Model Price India 2026: Complete Cost Guide",
                      href: "/blog/architectural-scale-model-price-india-2026",
                    },
                    {
                      label: "Scale Model Making India: Complete Guide (2026)",
                      href: "/blog/scale-model-making-india-complete-guide",
                    },
                    {
                      label:
                        "The Silent Salesperson: How Scale Models Close Deals",
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-black/80 max-w-2xl mx-auto">
                  ...
                  drawings and respond with a detailed, itemised quote and
                  production timeline — within 24 business hours.
                </p>
              </div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      maxLength={600}
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-transparent text-sm resize-none"
                      placeholder="Tell us about your project — size, number of towers, preferred scale, LED requirements, and target delivery date..."
                    ></textarea>
                  </div>
                  <button
                    type="submit"
