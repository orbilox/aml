...
export default function ConstructionUpdateVideosClient() {
  ...
  const portfolioProjects: Project[] = [
    ...
    },
    {
      ...
      description:
        "Comprehensive construction timeline documentation for premium residential project.",
      videoUrl:
      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: `url('https://readdy.ai/api/search-image?query=construction%20site%20aerial%20view%2C%20drone%20footage%2C%20building%20under%20construction%2C%20modern%20real%20estate%20development&width=1440&height=900&seq=construction-hero&orientation=landscape')`,
            }}
          ></div>
          <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
          <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-2xl">
              Construction Update Videos, Construction Time Lapse & Real Estate
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Professional construction videos, construction update videos,
                time lapse for construction sites, and real estate construction
                video services designed for developers, investors, and buyers.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-4xl mx-auto mt-6">
                From drone timelapse construction shoots to full-scale time
                lapse for construction sites, we help developers create
                compelling visual documentation and investor-ready construction
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">
                  Why Construction Update Videos & Time Lapse Matter
                </h2>
                  ...
                  {[
                    {
                      ...
                      desc: "Keep investors, buyers, and management informed using professional construction update videos and real estate construction video reporting.",
                    },
                    {
                      title: "Marketing Content",
                      desc: "Convert construction videos and construction time lapse footage into powerful real estate marketing assets that build buyer trust.",
                    },
                    {
                      title: "Quality Documentation",
                      desc: "Create detailed construction time lapse video documentation and visual project records for quality assurance and reporting.",
                    },
                    {
                      title: "Timeline Tracking",
                      desc: "Time lapse for construction sites helps showcase project milestones, worker productivity, and structural progress effectively.",
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-6">
                ...
                company offering construction videos, construction update
                videos, construction time lapse video production, and drone
                timelapse construction services for real estate developers
                across India.
              </p>
              ...
              <p className="text-lg text-gray-400 leading-relaxed">
                ...
                documentation solutions tailored for residential, commercial,
            ...
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
              ...
              <div>
                ...
                <p className="text-gray-800 text-lg leading-relaxed">
                  ...
                  update videos, construction videos, and construction time
                  lapse video documentation serve as verified visual evidence
                  while building buyer confidence throughout the construction
                  cycle.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              {[
                ...
                {
                  q: "How much does a construction update video cost?",
                  a: "Pricing depends on frequency, site size, and whether aerial footage is included. Contact our experts for a customised retainer package.",
                },
                {
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl p-12 shadow-lg">
              <h2 className="text-3xl font-bold text-black mb-4">
                Construction Videos & Time Lapse Pricing
              </h2>
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-gray-600 mb-8">
                Monthly retainer packages and per-shoot pricing available.
                Pricing depends on frequency, site size, and aerial footage
                requirements. Contact our experts for a custom package.
              </p>
              <a
                href="/contact"
