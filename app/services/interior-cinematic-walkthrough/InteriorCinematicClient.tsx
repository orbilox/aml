            ...
            {[
              {
                ...
                desc: "Share your floor plans, elevation drawings, and material finishes palette.",
              },
              {
                num: "02",
                title: "3D Modelling",
                desc: "We build photorealistic 3D interiors — furniture, lighting, materials, and accessories.",
              },
              {
                num: "03",
                title: "Lighting Setup",
                desc: "Cinematic lighting rigs simulate natural and artificial light at different times of day.",
              },
              {
                num: "04",
                title: "Render & Grade",
                desc: "High-resolution frames rendered and colour-graded to cinematic quality.",
              },
              {
                num: "05",
                title: "Final Delivery",
                desc: "4K walkthrough video with music, brand overlays, and all requested cut-downs.",
              },
            ].map((step) => (
            ...
            {[
              {
                icon: "ri-4k-line",
                title: "4K Resolution",
                desc: "3840×2160 cinema-grade output",
              },
              {
                icon: "ri-music-2-line",
                title: "Sound Design",
                desc: "Professional music & ambient audio",
              },
              {
                icon: "ri-palette-line",
                title: "Colour Grading",
                desc: "Cinematic LUT-graded colour",
              },
              {
                icon: "ri-film-line",
                title: "Multiple Cut-downs",
                desc: "30s, 60s & 90s social edits included",
              },
            ].map((item) => (
              <div
                key={item.title}
                className="bg-gray-900 rounded-2xl p-6 border border-gray-800 text-center hover:border-yellow-400 transition-colors"
              >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                q: "What is the difference between a 3D walkthrough and an interior cinematic walkthrough?",
                a: "A standard 3D walkthrough covers the entire project — exteriors, amenities, and multiple unit types — at a high level. An interior cinematic walkthrough focuses exclusively on the interior of a single typology, with cinematic lighting, rich material detail, and a film-grade look.",
              },
              {
                q: "How many typologies can be covered in one project?",
                a: "Each typology (e.g. 2BHK, 3BHK, penthouse) is treated as a separate production. We offer package discounts for multiple typologies in a single project.",
              },
              {
                q: "What inputs do you need from us?",
                a: "Floor plans, interior design intent (mood board or reference images), material specifications (flooring, wall finish, furniture style), and any specific camera angles or lifestyle moments you want highlighted.",
              },
              {
                q: "How long is the delivery timeline?",
                a: "A single typology cinematic walkthrough takes 4–6 weeks from brief to final delivery. Multiple typologies are delivered in phased milestones.",
              },
              {
                q: "Can we use the video for Instagram and social media ads?",
                a: "Yes. We deliver the full 2–3 minute cinematic alongside 30-second and 60-second social cuts optimised for Instagram Reels, YouTube Shorts, and Meta ads.",
              },
              {
                q: "How much does an interior cinematic walkthrough cost?",
                a: "Pricing depends on the level of interior detail, number of typologies, and output requirements. Contact our experts for a tailored quote.",
              },
            ].map((faq, i) => (
              <div
                key={i}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl p-12 shadow-lg">
            <h2 className="text-3xl font-bold text-black mb-4">
              Interior Cinematic Pricing
            </h2>
            <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
            <p className="text-gray-600 mb-8">
              Pricing is based on the number of typologies, level of interior
              detail, and output deliverables. Contact our experts for a package
            ...
            {[
              {
                ...
                desc: "Full project walkthroughs covering exteriors, amenities, and multiple unit types.",
                href: "/services/3d-walkthrough-video-company-india",
                icon: "ri-video-line",
              },
              {
                name: "Virtual Reality Tours",
                desc: "Interactive VR experiences letting buyers explore spaces at their own pace.",
                href: "/services/virtual-reality-tours",
                icon: "ri-vr-goggles-line",
              },
              {
                name: "3D Renders & Isometrics",
                desc: "Photorealistic still images for brochures, hoardings, and digital ads.",
