      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-2xl">
                Architectural Scale Models Service in India
              </h1>
              <p className="text-xl md:text-2xl text-white mb-8 leading-relaxed drop-shadow-lg">
                India&apos;s trusted 3D scale model maker for real estate
                developers, infrastructure projects, and property launches.
                End-to-end 3D model making service with LED integration, premium
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
                Professional 3D Model Making Service & Craftsmanship
              </h2>
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Handcrafted architectural scale models with exceptional detail
                and precision. As a full-service 3D model making service, we
                handle everything from concept to delivery — for presentations,
                sales offices, and exhibitions across India.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Expert artisans create detailed scale models using premium materials and traditional model-making techniques.",
                },
                {
                  icon: "ri-ruler-2-line",
                  title: "Accurate Scaling",
                  desc: "Precise measurements and proportions ensuring every detail matches your architectural drawings and specifications.",
                },
                {
                  icon: "ri-palette-line",
                  title: "Premium Materials",
                  desc: "High-quality materials including acrylic, wood, metal, and specialized modeling compounds for realistic finishes.",
                },
                {
                  icon: "ri-lightbulb-line",
                  title: "LED Lighting Integration",
                  desc: "Custom LED lighting systems to illuminate interiors, exteriors, and landscape features for dramatic presentations.",
                },
                {
                  icon: "ri-landscape-line",
                  title: "Landscape Details",
                  desc: "Detailed landscaping including trees, gardens, pathways, and environmental context to complete the presentation.",
                },
                {
                  icon: "ri-shield-check-line",
                  title: "Protective Display Cases",
                  desc: "Custom acrylic display cases with professional mounting to protect and showcase your scale model investment.",
                },
              ].map((f) => (
                <div
                  key={f.title}
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
                Types of Scale Models We Make
              </h2>
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                From luxury residential towers to large-scale infrastructure,
                our architectural scale models service in India covers every
                project type with equal precision.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Our structured 3D model making service follows a detail-driven
                approach — from drawing review to final delivery — ensuring
                precise, high-quality architectural scale models every time.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Review architectural drawings and references. Define model purpose. Finalize detailing level and delivery timeline.",
                },
                {
                  num: "2",
                  title: "Scale Selection & Material Planning",
                  desc: "Select the appropriate scale for the model. Choose materials like acrylic, wood, metal, or resin. Plan durability and display requirements.",
                },
                {
                  num: "3",
                  title: "Precision Model Making",
                  desc: "Accurate measurements and proportional execution. Professional scale model builders ensure precision. Handcrafted and tool-assisted construction.",
                },
                {
                  num: "4",
                  title: "Detailing, Lighting & Finishing",
                  desc: "Landscape, textures, and surface detailing. Optional LED lighting integration. Color matching and finish enhancement.",
                },
                {
                  num: "5",
                  title: "Quality Check & Delivery",
                  desc: "Accuracy and finish inspection. Secure packaging for safe transport. Ready-to-display model delivery.",
                },
              ].map((step) => (
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-yellow-400 mx-auto mb-6"></div>
              <p className="text-gray-600 max-w-2xl mx-auto">
                As India&apos;s trusted scale model making company, we combine
                expert craftsmanship, advanced 3D model making service
                capabilities, and deep real estate expertise to deliver
                world-class architectural scale models service in India.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
              {[
                {
                  title: "Expert Scale Model Makers & Builders",
                  desc: "Our team of professional scale model makers and scale model builders specialises in architectural scale models and precision miniature model making. Every model is crafted with strict attention to accuracy, proportion, and detailing to represent the architect's vision perfectly.",
                },
                {
                  title: "High-Realism Miniature Models",
                  desc: "We create high-realism miniature models using premium materials, advanced 3D model making techniques, and fine finishing. From textures and landscaping to elevations and lighting, our models deliver a lifelike visual experience that boosts client confidence.",
                },
                {
                  title: "Real Estate Scale Model Expertise",
                  desc: "With deep expertise in real estate scale models, we help developers present projects effectively at sales offices, exhibitions, and investor meetings. Our models simplify complex layouts, enhance buyer understanding, and support faster decision-making and higher conversions.",
                },
              ].map((item) => (
              ...
              {[
                {
                  ...
                  title: "ABS Plastic",
                  desc: "Precision CNC-cut ABS for crisp architectural details and structural elements.",
                },
                {
                  icon: "ri-water-flash-line",
                  title: "Acrylic & Glass",
                  desc: "Clear and frosted acrylic for glazing, water features, and feature facades.",
                },
                {
                  icon: "ri-lightbulb-flash-line",
                  title: "LED Lighting",
                  desc: "Integrated LED systems for unit illumination, landscape lighting, and lobby displays.",
                },
                {
                  icon: "ri-tree-line",
                  title: "Laser-Cut Wood",
                  desc: "MDF and balsa wood for landscape elements, podium levels, and organic forms.",
                },
                {
                  icon: "ri-paint-fill",
                  title: "Powder Coating",
                  desc: "Durable powder-coated finishes matching your brand colour palette precisely.",
                },
                {
                  icon: "ri-map-pin-line",
                  title: "Landscaping Elements",
                  desc: "Handcrafted trees, water bodies, roads, and site boundaries for complete site context.",
                },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              {[
                {
                  q: "What materials are used in architectural scale models?",
                  a: "We use ABS plastic, acrylic, MDF, balsa wood, powder-coated metal, and integrated LED lighting depending on the model type and display requirements. All materials are selected for durability and visual accuracy.",
                },
                {
                  q: "How long does it take to build a scale model?",
                  a: "A standard residential project model (1:200 scale) takes 4–6 weeks. Large township or commercial models take 8–12 weeks. Rush timelines are possible for specific requirements.",
                },
                {
                  q: "How is the model packaged and delivered?",
                  a: "Models are custom-packaged in foam-lined wooden crates for safe transport. We handle delivery across India and internationally. White-glove installation at your sales office is available.",
                },
                {
                  q: "Can the model be updated if the design changes?",
                  a: "Yes. We offer modification services for existing models — adding new towers, updating landscaping, or changing unit configurations without rebuilding the entire model.",
                },
                {
                  q: "What scale is typically used for real estate models?",
                  a: "1:100 for individual villas and apartments, 1:200 for mid-size residential projects, and 1:500 to 1:1000 for large townships. We recommend the best scale based on your display space and level of detail required.",
                },
                {
                  q: "How much does an architectural scale model cost?",
                  a: "Pricing depends on the scale, size, complexity, materials, and LED integration. Contact our experts for a detailed quote based on your project drawings.",
                },
                {
                  q: "Why is Alliance Media Labs the best architectural scale models service in India?",
                  a: "Alliance Media Labs is India's most experienced scale model making company — trusted by real estate developers from Pune to Hyderabad. Our in-house 3D scale model maker team offers a complete 3D model making service, from initial concept to white-glove installation. Every model is engineered for accuracy, durability, and visual impact.",
                },
              ].map((faq, i) => (
                <div
                  key={i}
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl p-12 shadow-lg">
              ...
              <p className="text-gray-600 mb-8">
                ...
                requirements. Contact our experts for a custom quote.
              </p>
              <a
                href="/contact"
