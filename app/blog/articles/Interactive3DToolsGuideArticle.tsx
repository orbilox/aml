      ...
      <div className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1 mb-8">
            ...
            <li><strong>Material and finish swappers:</strong> Layered onto a <Link href="/services/virtual-reality-tours" className="text-yellow-600 font-semibold hover:underline">VR tour</Link> or 360° walkthrough, this lets a buyer change wall paint, flooring, and fittings in real time inside the same navigable space.</li>
            <li><strong>Digital sales-office kiosks:</strong> A touchscreen version of any of the above, installed at the sales gallery as a self-guided station that runs alongside a physical <Link href="/services/scale-model-maker-india" className="text-yellow-600 font-semibold hover:underline">scale model</Link>.</li>
          </ul>
          ...
          <ol className="list-decimal list-inside text-gray-700 space-y-1 mb-8">
            <li><strong>3D model and unit library build.</strong> Every unit typology, floor plate, and finish option is modelled — the same base assets often reused for <Link href="/services/3d-renders-isometrics" className="text-yellow-600 font-semibold hover:underline">3D renders</Link> and walkthroughs.</li>
          ...
          <p className="text-gray-700 leading-relaxed mb-8">
            A common high-performing combination: a physical <Link href="/services/scale-model-maker-india" className="text-yellow-600 font-semibold hover:underline">scale model</Link> as the gallery centerpiece, an interactive configurator kiosk beside it for unit-level detail, and a <Link href="/services/virtual-reality-tours" className="text-yellow-600 font-semibold hover:underline">VR tour</Link> link sent to remote buyers who can&apos;t visit in person.
          </p>
